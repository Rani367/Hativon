  ...
  try {
    ...
    if (!exists) {
      return {
        ...
        details: 'Run "bun run db:init" to initialize the database',
      };
    }
  ...
  try {
    ...
    if (adminCount === 0) {
      return {
        ...
        details: 'Run "bun run create-admin" to create an admin account',
      };
    }
  ...
  try {
    ...
    if (!hasUsernameIndex) {
      return {
        ...
        details: 'Run "bun run db:init" to create required indexes',
      };
    }
