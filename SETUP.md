...
This project features a **fully automated setup** that configures everything with a single command.
...
git clone <repo-url>
cd school-newspaper
pnpm install        # ← Sets up EVERYTHING automatically!
...
### 6. **Creates Admin User** (if database configured)
   - Username: `admin`
   - Password: `admin123`
   - Display name: `מנהל` (Admin in Hebrew)
