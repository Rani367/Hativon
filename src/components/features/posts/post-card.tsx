...
export default function PostCard({ post, priority = false }: PostCardProps) {
  ...
  return (
    <Card className="group relative pt-0 overflow-hidden hover:shadow-xl transition-shadow duration-200 bg-card/50 backdrop-blur supports-[backdrop-filter]:bg-background/60 break-inside-avoid-column mb-6 backface-hidden">
      <Link
